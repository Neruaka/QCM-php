...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 29 jan. 2023 à 16:05
...
--
-- Structure de la table `qcmhisto`
--

DROP TABLE IF EXISTS `qcmhisto`;
CREATE TABLE IF NOT EXISTS `qcmhisto` (
...
--
-- Déchargement des données de la table `qcmhisto`
--

INSERT INTO `qcmhisto` (`idqcm`, `idu`, `note`, `date`) VALUES
(1, 1, 8, '2023-01-27 08:56:44'),
(2, 1, 0, '2023-01-27 11:39:43'),
(4, 9, 2, '2023-01-28 19:45:47');
...
INSERT INTO `user` (`id`, `pseudo`, `passwd`, `level`) VALUES
(1, 'admin', 'admin', 1),
(2, 'user', 'user', 2),
(9, 'blqblq', 'lbabla', 2),
(10, 'fredo', 'fredomdp', 2);
...
--
-- Contraintes pour la table `qcmhisto`
--
ALTER TABLE `qcmhisto`
  ADD CONSTRAINT `qcmhisto_ibfk_1` FOREIGN KEY (`idu`) REFERENCES `user` (`id`);
COMMIT;
